...
Unbound resources will be initialized by a static initialization method
`__createFromImplicitBinding` which is described
[here](0025-resource-initialization-and-constructors.md#resources-with-implicit-binding).
...
The builtin function `__builtin_hlsl_resource_handlefromimplicitbinding` will be
